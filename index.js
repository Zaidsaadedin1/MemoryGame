...
const listOfCards = [];
const clickSound = new Audio('../imgs/nigga.mp4');
let timeLeft = 0;
...
function setCardsOverScreen(numberOfCards, timer, chances) {
  ...
  setTimeout(() => {
    ...
    }, 1000); // Adjust the delay before resetting all cards as needed
...
function restartGame() {
  ...
  setCardsOverScreen(numberOfCards, initialTimerValue, initialChancesValue);
}
